...
const Banner = () => {
    return (
        <div className='px-50 py-15 flex items-center justify-between bg-[#FFFFFF]'>
            <div>
                <div className='px-4 py-2 bg-[#E1E7FF] rounded-[1000px] flex items-center gap-1.25 w-fit'>
                ...
                <h1 className='manrope font-extrabold text-[72px] leading-21 tracking-[0%] text-[#101727]'>Supercharge Your Digital Workflow</h1>
                <p className='manrope font-normal text-[18px] leading-5 tracking-[0%] text-[#627382]'>Access premium AI tools, design assets, templates, and productivity software—all in one place. Start creating faster today.Explore Products.</p>
